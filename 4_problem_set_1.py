...
#Alternative methods using if condition
...
reversed_name =""
for char in name:
    #What is going on here? - we are looping through each character in the string and adding it to the fron of reversed_name
...
#Recursion mean a function calls itslef
